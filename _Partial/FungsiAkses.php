<?php
    ...
    // Pastikan $SessionIdAkses telah diinisialisasi
    if (!isset($SessionIdAkses)) {
        // Inisialisasi $SessionIdAkses sesuai kebutuhan Anda
        $SessionIdAkses = ''; // atau nilai default yang sesuai
    }
    ...
    $PA = IjinAksesKode($Conn, $SessionIdAkses, 'PA');
