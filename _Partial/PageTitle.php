                                                        ...
                                                        if($_GET['Page']=="Help"){
                                                            ...
                                                            if($_GET['Page']=="RiwayatAnggota"){
                                                                ...
                                                                if($_GET['Page']=="StockOpename"){
                                                                    echo '<h1><i class="bi bi-truck-flatbed"></i> Stock Barang</h1>';
                                                                    echo '<nav>';
                                                                    echo '  <ol class="breadcrumb">';
                                                                    echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                    echo '      <li class="breadcrumb-item active">Stock Barang</li>';
                                                                    echo '  </ol>';
                                                                    echo '</nav>';
                                                                }else{
                                                                    if($_GET['Page']=="JadwalPraktek"){
                                                                        ...
                                                                        if($_GET['Page']=="Kunjungan"){
                                                                            ...
                                                                            if (isset($_GET['Page']) && $_GET['Page'] == "KontenWeb") {
                                                                                if (isset($_GET['Sub']) && $_GET['Sub'] == "KontenUmum") {
                                                                                ...
                                                                                if (isset($_GET['Sub']) && $_GET['Sub'] == "PagePosting") {
                                                                                    echo '<h1><i class="bi bi-google"></i> Konten Web</h1>';
                                                                                    echo '<nav>';
                                                                                    echo '  <ol class="breadcrumb">';
                                                                                    echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                ...
                                                                                if (isset($_GET['Sub']) && $_GET['Sub'] == "TambahPagePosting") {
                                                                                    echo '<h1><i class="bi bi-google"></i> Konten Web</h1>';
                                                                                    echo '<nav>';
                                                                                    echo '  <ol class="breadcrumb">';
                                                                                    echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                ...
                                                                                if (isset($_GET['Sub']) && $_GET['Sub'] == "EditPagePosting") {
                                                                                    echo '<h1><i class="bi bi-google"></i> Konten Web</h1>';
                                                                                    echo '<nav>';
                                                                                    echo '  <ol class="breadcrumb">';
                                                                                    echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                ...
                                                                                if (isset($_GET['Sub']) && $_GET['Sub'] == "UrlDinamis") {
                                                                                    echo '<h1><i class="bi bi-google"></i> Konten Web</h1>';
                                                                                    echo '<nav>';
                                                                                    echo '  <ol class="breadcrumb">';
                                                                                    echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                ...
                                                                                if (isset($_GET['Sub']) && $_GET['Sub'] == "Testimoni") {
                                                                                    echo '<h1><i class="bi bi-google"></i> Konten Web</h1>';
                                                                                    echo '<nav>';
                                                                                    echo '  <ol class="breadcrumb">';
                                                                                    echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                ...
                                                                                if (isset($_GET['Sub']) && $_GET['Sub'] == "FAQ") {
                                                                                    echo '<h1><i class="bi bi-google"></i> Konten Web</h1>';
                                                                                    echo '<nav>';
                                                                                    echo '  <ol class="breadcrumb">';
                                                                                    echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                ...
                                                                                if($_GET['Page']=="PembiayaanAnggota"){
                                                                                    if(empty($_GET['Sub'])){
                                                                                        echo '<h1><i class="bi bi-wallet"></i> Pembiayaan Anggota</h1>';
                                                                                        echo '<nav>';
                                                                                        echo '  <ol class="breadcrumb">';
                                                                                        echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                        echo '      <li class="breadcrumb-item active">Pembiayaan Anggota</li>';
                                                                                        echo '  </ol>';
                                                                                        echo '</nav>';
                                                                                    }else{
                                                                                        if($_GET['Sub']=="TambahPembiayaan"){
                                                                                            echo '<h1><i class="bi bi-wallet"></i> Pembiayaan Anggota</h1>';
                                                                                            echo '<nav>';
                                                                                            echo '  <ol class="breadcrumb">';
                                                                                            echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                            echo '      <li class="breadcrumb-item"><a href="index.php?Page=Pembiayaan Anggota">Pembiayaan Anggota</a></li>';
                                                                                            echo '      <li class="breadcrumb-item active">Tambah Pembiayaan</li>';
                                                                                            echo '  </ol>';
                                                                                            echo '</nav>';
                                                                                        }else{
                                                                                            if($_GET['Sub']=="DetailPembiayaan"){
                                                                                                echo '<h1><i class="bi bi-wallet"></i> Detail Pembiayaan</h1>';
                                                                                                echo '<nav>';
                                                                                                echo '  <ol class="breadcrumb">';
                                                                                                echo '      <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>';
                                                                                                echo '      <li class="breadcrumb-item"><a href="index.php?Page=PembiayaanAnggota">Pembiayaan Anggota</a></li>';
                                                                                                echo '      <li class="breadcrumb-item active">Detail Pembiayaan</li>';
                                                                                                echo '  </ol>';
                                                                                                echo '</nav>';
                                                                                            }
                                                                                        }
