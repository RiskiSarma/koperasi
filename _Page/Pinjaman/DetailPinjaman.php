<?php
    ...
    if(empty($_GET['id'])){
        ...
        $id_akses= $DataPinjaman['id_akses'] ?? 0;
        $tanggal_pinjaman= $DataPinjaman['tanggal_pinjaman'] ?? 0;
        $tanggal_input= $DataPinjaman['tanggal_input'] ?? 0;
        $nama= $DataPinjaman['nama'] ?? 0;
        $jumlah_pinjaman= $DataPinjaman['jumlah_pinjaman'] ?? 0;
        $persen_jasa= $DataPinjaman['persen_jasa'] ?? 0;
        $nilai_angsuran= $DataPinjaman['nilai_angsuran'] ?? 0;
        $periode_angsuran= $DataPinjaman['periode_angsuran'] ?? 0;
        $token= $DataPinjaman['token'] ?? 0;
        $status= $DataPinjaman['status'] ?? 0;
