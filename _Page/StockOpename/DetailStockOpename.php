<?php
    ...
    if(empty($_GET['id'])){
        ...
        echo '      <h4 class="card-title">Detail Stock Barang</h4>';
        echo '  </div>';
        ...
        $JumlahAsset = $SumJumlahAsset['jumlah'] ?? 0;
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-10">
                            <b class="card-title">
                                <i class="bi bi-info-circle"></i> Info stock Barang
                            </b>
                        </div>
                        <div class="col-md-2">
