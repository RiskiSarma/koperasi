<?php
    ...
    if(empty($id_simpanan)){
        ...
        $id_simpanan= $DataSimpanan['id_simpanan'] ?? 0;
        $id_anggota= $DataSimpanan['id_anggota'] ?? 0;
        $kategori= $DataSimpanan['kategori'] ?? 0;
        $keterangan= $DataSimpanan['keterangan'] ?? 0;
        $nama= $DataSimpanan['nama'] ?? 0;
        $jumlah= $DataSimpanan['jumlah'] ?? 0;
        $tanggal= $DataSimpanan['tanggal'] ?? 0;
                                                                ...
                                                                if(empty($data['id_simpanan'])){
                                                                    if(empty($data['id_pinjaman_angsuran'])){
                                                                        if(empty($data['id_pinjaman'])){
                                                                            ...
                                                                            $tanggal_pinjaman= $DataPinjaman['tanggal_pinjaman'] ?? 0;
