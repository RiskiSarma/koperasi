$(document).ready(function() {
    ...
    $('#KeywordBy').change(function(){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error in KeywordBy change: ", status, error);
            }
        });
    });
    ...
    $('#batas').change(function(){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error in batas change: ", status, error);
            }
        });
    });
    ...
    $('#BatasAksesAnggota').change(function(){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error in BatasAksesAnggota change: ", status, error);
            }
        });
    });
    ...
    $('#StatusAksesAnggota').change(function(){
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error in StatusAksesAnggota change: ", status, error);
            }
        });
    });
    ...
    $('#ProsesBatas').submit(function(e){
        e.preventDefault();
        var ProsesBatas = $(this).serialize();
        $('#MenampilkanTabelAnggota').html('Loading...');
        $.ajax({
            type: 'POST',
            url: '_Page/Anggota/TabelAnggota.php',
            ...
            error: function(xhr, status, error) {
                console.error("Error in ProsesBatas submit: ", status, error);
            }
        });
    });

    $('#ProsesBatasAksesAnggota').submit(function(e){
        e.preventDefault();
        var ProsesBatasAksesAnggota = $(this).serialize();
        $('#MenampilkanTabelAksesAnggota').html('Loading...');
        $.ajax({
            type: 'POST',
            url: '_Page/Anggota/TabelAksesAnggota.php',
            ...
            error: function(xhr, status, error) {
                console.error("Error in ProsesBatasAksesAnggota submit: ", status, error);
            }
        });
    });

    $('#ProsesFilterAnggota').submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error in ProsesFilterAnggota submit: ", status, error);
            }
        });
    });
});
$(document).ready(function() {
    ...
    $('#ModalTambahAnggota').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $('#ProsesTambahAnggota').submit(function(e){
                    e.preventDefault();
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            console.error("Error in ProsesTambahAnggota submit: ", status, error);
                        }
                    });
                });
            },
            error: function(xhr, status, error) {
                console.error("Error in ModalTambahAnggota: ", status, error);
            }
        });
    });
    ...
    $('#ModalDetailAnggota').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error in ModalDetailAnggota: ", status, error);
            }
        });
    });
    ...
    $('#ModalEditAnggota').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                // Proses Edit Anggota
                $('#ProsesEditAnggota').submit(function(e){
                    e.preventDefault();
                        ...
                        success: function(data){
                            ...
                            if(NotifikasiEditAnggotaBerhasil == "Success"){
                                $.ajax({
                                    ...
                                    error: function(xhr, status, error) {
                                        console.error("Error in reloading TabelAnggota after edit: ", status, error);
                                    }
                                });
                            }
                        },
                        error: function(xhr, status, error) {
                            console.error("Error in ProsesEditAnggota submit: ", status, error);
                        }
                    });
                });
            },
            error: function(xhr, status, error) {
                console.error("Error in ModalEditAnggota: ", status, error);
            }
        });
    });
                        ...
                        success: function(data){
                            ...
                            if(NotifikasiHapusAnggotaBerhasil == "Success"){
                                $.ajax({
                                    ...
                                    error: function(xhr, status, error) {
                                        console.error("Error in reloading TabelAnggota after delete: ", status, error);
                                    }
                                });
                            }
                        },
                        error: function(xhr, status, error) {
                            console.error("Error in ProsesHapusAnggota: ", status, error);
                        }
                    });
                });
            },
            error: function(xhr, status, error) {
                console.error("Error in ModalDeleteAnggota: ", status, error);
            }
        });
    });
    ...
    $('#ModalEditAnggota2').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                // Proses Edit Anggota
                $('#ProsesEditAnggota2').submit(function(e){
                    e.preventDefault();
                    $('#NotifikasiEditAnggota').html('<div class="spinner-border text-secondary" role="status"><span class="sr-only"></span></div>');
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            console.error("Error in ProsesEditAnggota2 submit: ", status, error);
                        }
                    });
                });
            },
            error: function(xhr, status, error) {
                console.error("Error in ModalEditAnggota2: ", status, error);
            }
        });
    });
            ...
            success: function(data){
                ...
                $('#KonfirmasiHapusAnggota2').click(function(){
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            console.error("Error in ProsesHapusAnggota2: ", status, error);
                        }
                    });
                });
            },
            error: function(xhr, status, error) {
                console.error("Error in ModalDeleteAnggota2: ", status, error);
            }
        });
    });
});
    ...
    $('#RincianAnggota').click(function(){
        ...
        $ajax({
            ...
            success: function(data){
                ...
                fetchTabelRincian(GetIdAnggota);
            },
            error: function(xhr, status, error) {
                console.error("Error in fetching RinciannAnggota data: ", status, error);
            }
        });
    });

    // Function to fetch and display tabel rincian
    function fetchTabelRincian(idAnggota) {
        $.ajax({
            type: 'POST',
            ...
            error: function(xhr, status, error) {
                console.error("Error in fetching TabelRincianAnggota data: ", status, error);
            }
        });
    }

    // Ketika form pencarian disubmit
    $(document).on('submit', '#ProsesBatasRincian', function(e) {
        e.preventDefault(); // Mencegah submit default
        var ProsesBatasRincian = $(this).serialize();
        $('#MenampilkanTabelRincian').html('Loading...');
        fetchTabelRincian(ProsesBatasRincian);
    });

    // Ketika Batas Rincian berubah
    $('#BatasRincian').change(function() {
        $('#MenampilkanTabelRincian').html('Loading...');
        fetchTabelRincian($('#ProsesBatasRincian').serialize());
    });

    // Ketika ShortBy Rincian berubah
    $('#ShortByRincian').change(function() {
        $('#MenampilkanTabelRincian').html('Loading...');
        fetchTabelRincian($('#ProsesBatasRincian').serialize());
    });

    // Ketika KeywordBy Rincian berubah
    $('#KeywordByRincian').change(function() {
        var KeywordByRincian = $(this).val();
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                console.error("Error in fetching FormKeywordRincian data: ", status, error);
            }
        });
    });
});
