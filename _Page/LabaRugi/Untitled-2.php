                        ...
                        <?php
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                if ($Saldo != 0) {
                                    ...
                                    echo '    <td class="text-right">' . number_format($JumlahDebet, 0, ',', '.') . '</td>';
                                    echo '    <td class="text-right">' . number_format($JumlahKredit, 0, ',', '.') . '</td>';
                            ...
                            echo '    <td colspan="6" align="right"><b>Total Aktiva</b></td>';
                            echo '    <td class="text-right"><b>' . $total_aktivaRp . '</b></td>';
                            echo '</tr>';

                            echo '<tr class="table-danger">';
                            echo '    <td colspan="6" align="right"><b>Total Passiva</b></td>';
