    ...
    <body>
        <table class="data" width="100%" cellspacing="0">
            ...
            <?php
                if(empty($jml_data)){
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                        ...
                        if(!empty($data['id_anggota'])){
                            ...
                            $nama_anggota= $DataAnggota['nama'] ?? 0;
                        }else{
                            $nama_anggota="None";
                        }
                        //Buka Supplier
                        ...
                        $NamaAksesTransaksi= $DataAksesTransaksi['nama_akses'] ?? 0;
                    ?>
                <tr>
                    <td align="center">
                ...
                ?>
                <?php
                    // Pastikan bahwa $JumlahTagihan dan $JumlahPembayaran telah didefinisikan dan memiliki nilai.
                    $JumlahTagihan = isset($JumlahTagihan) ? $JumlahTagihan : 0;
                    $JumlahPembayaran = isset($JumlahPembayaran) ? $JumlahPembayaran : 0;
                ?>
