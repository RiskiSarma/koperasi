                                    ...
                                    for ( $i =$a; $i<=$b; $i++ ){
                                        ...
                                        if(empty($KategoriTransaksi)){
                                            if(empty($StatusStransaksi)){
                                                ...
                                                $DataTransaksi = $SumTransaksi['tagihan'] ?? 0; // Default to 0 if null
                                            ...
                                            if (empty($StatusStransaksi)) {
                                                ...
                                                $DataTransaksi = $SumTransaksi['tagihan'] ?? 0; // Jika null, beri nilai 0
                                                $JumlahTransaksiRp = "" . number_format($DataTransaksi, 0, ',', '.');
                                                ...
                                                $JumlahTransaksiRp = $DataTransaksi !== null ? number_format($DataTransaksi, 0, ',', '.') : '0'; // Cek jika null, beri nilai 0
